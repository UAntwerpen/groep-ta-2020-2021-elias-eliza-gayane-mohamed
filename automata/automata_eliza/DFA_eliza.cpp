...
bool DFA_eliza::accepts(const string &input) {
...
DFA_eliza::DFA_eliza(const string &file_name) {
    ifstream input_file;
...
bool DFA_eliza::is_start_state(const State* state) const {
    return state == start_state;
}

bool DFA_eliza::is_accepting_state(const State* state) const {
